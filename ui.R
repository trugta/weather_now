...
shinyUI(dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      div(
        class = "user-profile",
        tags$img(src = "https://png.pngtree.com/png-clipart/20220911/original/pngtree-cute-sunny-png-image_8544640.png", width = "50px", height = "50px"),
        div(
          style = "display: inline-block; vertical-align: top; margin-top: 5px; margin-left: 10px;",
          p("Lê Trung Tá", style = "text-align: center; font-size: 15px; margin: 0;"),
          div(
